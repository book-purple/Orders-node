...
class OrderStateMachine {
     ...
     * @param {Object} order
     */
    moveOrderToPendingWithVendor(order) {
     ...
     * @param {Object} order
     */
    moveOrderToAcceptedByVendor(order) {
     ...
     * @param {Object} order
     */
    moveOrderToExpiredFromVendor(order) {
     ...
     * @param {Object} order
     */
    moveOrderToOrderVerified(order) {
     ...
     * @param {Object} order
     */
    moveOrderToOrderComplete(order) {
     ...
     * @param {Object} order
     */
    moveOrderToPendingWithUser(order) {
     ...
     */
    getOrderState(orderStateName, orderStateId) {
        return orderState = {
    ...
    /**
     * Function to exec order to next state
     * @param event
     * @param order
     * @returns {*}
     */
    execNextState(event, order) {
        switch (event) {
            case NEW_ORDER:
